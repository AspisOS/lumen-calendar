...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=lumen-calendar                # herald package id (== repo name)
NAME="Calendar"                  # human-readable name
DESTBIN=apps/calendar/calendar   # where the binary installs (verbatim runtime path)
